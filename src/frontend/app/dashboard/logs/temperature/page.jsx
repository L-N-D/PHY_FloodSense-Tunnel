    ...
    return (
        <div className="mt-[60px] flex flex-col gap-10 flex-1 h-screen bg-[#060C11] 
            ...
            <div className={widgetPanel}>
                ...
                <h2 className="text-2xl font-semibold mt-4">Temperature Sensor</h2>

                <div className="w-full px-8 mt-6 flex justify-between items-center">

                    {/* LEFT: Temperature */}
                    <div className="flex items-center gap-3">
                        <i className="fa-solid fa-temperature-three-quarters text-red-400 text-2xl"></i>

                        <div>
                            <div className="text-gray-300 text-xl">Temperature</div>
                            <div className="text-white text-2xl font-semibold">{tempData} °C</div>
                        </div>
                    </div>
