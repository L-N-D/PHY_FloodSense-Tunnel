    ...
    return (
        <div className="mt-[60px] flex flex-col gap-10 flex-1 h-screen bg-[#060C11] 
            ...
            <div className={widgetPanel}>
                ...
                <h2 className="text-2xl font-semibold mt-4">Water Level</h2>

                <div className="w-full px-8 mt-6 flex justify-between items-center">

                    <div className="flex items-center gap-3">
                        <i className="fa-solid fa-water text-red-400 text-2xl"></i>

                        <div>
                            <div className="text-gray-300 text-xl">Water level</div>
                            <div className="text-white text-2xl font-semibold">{waterLevelData} cm</div>
                        </div>
                    </div>
