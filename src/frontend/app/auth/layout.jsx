...
const buttonLiquidGlass =
  "fixed left-2 top-0 w-[40px] h-[40px] mt-4 flex flex-col justify-center items-center \
   bg-white/5 backdrop-blur-md border border-white/40 rounded-full \
   shadow-[inset_0_1px_0px_rgba(255,255,255,0.7),0_0_10px_rgba(0,0,0,0.1),0_4px_10px_rgba(0,0,0,0.15)] \
    ...
    return (
        <div className="flex-1 bg-[#060C11] flex flex-col justify-center items-center">
            ...
            <div className={liquidGlassClasses}>
                <a href="/home" className={buttonLiquidGlass}>
